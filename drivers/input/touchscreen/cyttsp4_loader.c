...
u16 cyttsp4_get_phone_conf_ver(void)
{
    return SAMSUNG_CONFIG_VERSION;
}

u16 cyttsp4_get_phone_hw_ver(void)
{
...
#else
	fw_ver_img = data->si->si_ptrs.samsung_data->fw_versionh;
#endif
